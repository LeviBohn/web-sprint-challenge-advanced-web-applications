...
export default function App() {
  ...
  const getArticles = () => {
    ...
    axios.get(articlesUrl, { headers: { authorization: authToken } })
      .then(response => {
  ...
  const postArticle = article => {
    ...
    setSpinnerOn(true);
    const authToken = localStorage.getItem('token');
    axios.post(articlesUrl, article, { headers: { authorization: authToken } })
      .then(response => {
    ...
    axios.put(`${articlesUrl}/${article_id}`, article, {
      ...
      .then((response) => {
        const updatedArticles = articles.map((item) =>
          item.article_id === article_id ? response.data.article : item
        );
